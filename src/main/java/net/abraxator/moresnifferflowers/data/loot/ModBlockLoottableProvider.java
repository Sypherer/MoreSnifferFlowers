    ...
    protected void generate() {
        ...
        add(ModBlocks.AMBER_BLOCK.get(), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        .when(doesNotHaveSilkTouch())
                        //COMMON
                        .add(LootItem.lootTableItem(Items.COAL).setWeight(500))
                        .add(LootItem.lootTableItem(Items.EMERALD).setWeight(500))
                        .add(LootItem.lootTableItem(Items.STICK).setWeight(500))
                        .add(LootItem.lootTableItem(ModItems.AMBER_SHARD.get()).setWeight(500))
                        .add(LootItem.lootTableItem(ModItems.DRAGONFLY.get()).setWeight(500))
                        //UNCOMMON
                        .add(LootItem.lootTableItem(Items.CARROT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.POTATO).setWeight(200))
                        .add(LootItem.lootTableItem(Items.BEETROOT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.BEETROOT_SEEDS).setWeight(200))
                        .add(LootItem.lootTableItem(Items.NETHER_WART).setWeight(200))
                        .add(LootItem.lootTableItem(Items.WHEAT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(200))
                        //RARE
                        .add(LootItem.lootTableItem(ModItems.DISC_FRAGMENT_BOBLING.get()).setWeight(75))
                        .add(LootItem.lootTableItem(Items.SNORT_POTTERY_SHERD).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.BELT_PIECE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.ENGINE_PIECE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.SCRAP_PIECE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.TUBE_PIECE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.PRESS_PIECE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.AROMA_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.AMBUSH_BANNER_PATTERN.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.EXTRACTION_BOTTLE.get()).setWeight(75))
                        //VERY RARE
        ...
        add(ModBlocks.GARNET_BLOCK.get(), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                        ...
                        //COMMON
                        .add(LootItem.lootTableItem(Items.EXPERIENCE_BOTTLE).setWeight(500))
                        .add(LootItem.lootTableItem(Items.RAW_COPPER).setWeight(500))
                        .add(LootItem.lootTableItem(Items.EMERALD).setWeight(500))
                        .add(LootItem.lootTableItem(Items.RAW_IRON).setWeight(500))
                        .add(LootItem.lootTableItem(ModItems.GARNET_SHARD.get()).setWeight(500))
                        .add(LootItem.lootTableItem(Items.RAW_GOLD).setWeight(500))
                        //UNCOMMON

                        .add(LootItem.lootTableItem(ModItems.DISC_FRAGMENT_BOBLING.get()).setWeight(200))
                        .add(LootItem.lootTableItem(Items.GOLDEN_CARROT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(200))
                        .add(LootItem.lootTableItem(Items.IRON_INGOT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.GOLD_INGOT).setWeight(200))
                        .add(LootItem.lootTableItem(Items.DIAMOND).setWeight(200))

                        //RARE
                        .add(LootItem.lootTableItem(Items.GOLDEN_APPLE).setWeight(75))
                        .add(LootItem.lootTableItem(Items.TOTEM_OF_UNDYING).setWeight(75))
                        .add(LootItem.lootTableItem(ModBlocks.CORRUPTED_SAPLING.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.CARNAGE_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(75))
                        .add(LootItem.lootTableItem(ModItems.EVIL_BANNER_PATTERN.get()).setWeight(75))
                        .add(LootItem.lootTableItem(Items.NETHERITE_SCRAP).setWeight(75))
